...
export class RegistrationPageComponent implements OnInit {
    ...
    registrationCapPercentage: number = 0
    ...
    constructor(
        ...
        this.hasAdminRole =
            this.userTokenInfo &&
            this.userTokenInfo.roles &&
            this.userTokenInfo.roles.includes("admin")
        this.canBackdoor =
            this.userTokenInfo &&
            this.userTokenInfo.roles &&
        ...
        this.speedrunEventService
            ...
            .subscribe((srEvent: SpeedrunEvent) => {
                ...
                this.registrationCapPercentage =
                    (srEvent.registeredUsersCount /
                        srEvent.maxRegisteredUsers) *
                    100
                console.log(this.registrationCapPercentage)
            })
    }
    ...
    ngOnInit() {
        this.handler = StripeCheckout.configure({
            ...
            token: (token: any) => {
                ...
                this.paymentService
                    .processPayment(token, this.paymentAmount)
                    .subscribe(
                        (res: any) => {
                            this.spinnerMessage +=
                                " Payment successful! Registering for event..."
                            this.userService.registerUser().subscribe(
                                ...
                                (err: any) => {
                                    ...
                                    this.spinnerError =
                                        "Something went wrong. It looks like your payment was " +
                        ...
                        (err: any) => {
                            this.spinnerError =
                                "It appears we were unable to charge your credit card. Please confirm " +
    ...
    handlePayment(e: any) {
        ...
        if (this.userTokenInfo.roles.includes("skip-payment")) {
            this.isProcessingPayment = true
            this.spinnerMessage =
                "Processing payment... Payment successful! Registering for event..."
            this.userService.registerUser().subscribe(
                (regRes: any) => {
                    this.user = regRes.data
                    this.isProcessingPayment = false
        ...
        this.speedrunEventService
            ...
            .subscribe((srEvent: SpeedrunEvent) => {
                ...
                if (
                    srEvent.registeredUsersCount >= srEvent.maxRegisteredUsers
                ) {
