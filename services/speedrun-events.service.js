...
exports.createSpeedrunEvent = async function (speedrunEvent) {
    ...
    try {
        ...
        throw Error(
            `Error while attempting to save new speedrun event: ${e.message}`
        )
    }
}
...
exports.updateSpeedrunEvent = async function (speedrunEvent) {
    ...
    try {
        ...
        throw Error(
            `Error occurred while updating speedrun event: ${e.message}`
        )
    }
}
...
exports.deleteSpeedrunEvent = async function (id) {
    try {
        ...
        throw Error(
            `Error occurred while attempting to delete speedrun event: ${e.message}`
        )
    }
}
...
exports.getSpeedrunEvent = async function (name) {
    try {
        ...
        throw Error(
            `Error occurred while attempting to retrieve speedrun event information: ${e.message}`
        )
    }
}
