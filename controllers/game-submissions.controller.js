...
exports.createSubmission = async function (req, res, next) {
	...
	let submission = {
		...
		uploadBandwidth: req.body.uploadBandwidth,
		techNotes: req.body.techNotes,
...
exports.updateSubmission = async function (req, res, next) {
	...
	let submission = {
		...
		availability: req.body.availability ? req.body.availability : null,
		isRemote: req.body.isRemote !== undefined ? req.body.isRemote : null,
		uploadBandwidth: req.body.uploadBandwidth ? req.body.uploadBandwidth: null,
		techNotes: req.body.techNotes ? req.body.techNotes : null,
